import { CreateAgeTypeBody, GetAgeTypeQuery } from "./ageType.validation";
...
export class AgeTypeService {
    ...
    async updateAgeType(id: string, data: CreateAgeTypeBody, userId: string) {
